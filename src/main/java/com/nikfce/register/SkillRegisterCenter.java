...
public class SkillRegisterCenter {
    ...
    public static Class<? extends Skill> getClassByCode(String code) {
        return SKILL_MAP.get(code);
    }

    /**
     * 根据传入的技能码返回一个对应的技能实例
     */
    public static Skill generateSkill(String skillCode) throws InstantiationException, IllegalAccessException {
